...
#        return gdata
    ...
    def event_trig_average(self, **kwargs):
        ...
        **kwargs
        ...
        gdata = self.lfp.event_trig_average(self.spike.get_unit_stamp(), **kwargs)
    ...
    def spike_lfp_causality(self, **kwargs):
        ...
        **kwargs
        ...
        gdata = self.lfp.spike_lfp_causality(self.spike.get_unit_stamp(), **kwargs)
        self.update_results(self.lfp.get_results())
    ...
    def angular_velocity(self, **kwargs):
        ...
        **kwargs
        ...
        gdata = self.spatial.angular_velocity(self.spike.get_unit_stamp(), **kwargs)
        self.update_results(self.spatial.get_results())
    ...
    def loc_time_lapse(self, **kwargs):
        ...
        **kwargs
        ...
        """
        gdata = self.spatial.loc_time_lapse(self.spike.get_unit_stamp(), **kwargs)
    ...
    def loc_shift(self, shift_ind=np.arange(-10, 11), **kwargs):
        ...
        **kwargs
        ...
        gdata = self.spatial.loc_shift(self.spike.get_unit_stamp(), shift_ind=shift_ind, **kwargs)
        self.update_results(self.spatial.get_results())
    ...
    def loc_auto_corr(self, **kwargs):
        ...
        **kwargs
        ...
        """
        gdata = self.spatial.loc_auto_corr(self.spike.get_unit_stamp(), **kwargs)
    ...
    def loc_rot_corr(self, **kwargs):
        ...
        **kwargs
        ...
        gdata = self.spatial.loc_rot_corr(self.spike.get_unit_stamp(), **kwargs)
    ...
    def hd_shift(self, shift_ind=np.arange(-10, 11), **kwargs):
        ...
        **kwargs
        ...
        gdata = self.spatial.hd_shift(self.spike.get_unit_stamp(), shift_ind=shift_ind)
        self.update_results(self.spatial.get_results())
    ...
    def multiple_regression(self, **kwargs):
        ...
        **kwargs
        ...
        """
        gdata = self.spatial.multiple_regression(self.spike.get_unit_stamp(), **kwargs)
        self.update_results(self.spatial.get_results())
